        ...
        for potential_key in self.key_map.values():
            ...
            self.potentials[potential_key] = Potential(
                parameters={
                    ...
                    "axisType": Quantity(int(parameter.axisType), unit.dimensionless),
                    "multipoleAtomZ": Quantity(int(parameter.multipoleAtomZ), unit.dimensionless),
                    "multipoleAtomX": Quantity(int(parameter.multipoleAtomX), unit.dimensionless),
                    "multipoleAtomY": Quantity(int(parameter.multipoleAtomY), unit.dimensionless),
